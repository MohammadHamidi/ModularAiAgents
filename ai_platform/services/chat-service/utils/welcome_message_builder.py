...
def _greeting_prefix(first_name: Optional[str]) -> str:
    ...
    # Greeting disabled - return empty string
    return ""
...
def get_welcome_message_and_starters(
    ...
    if agent_key == "guest_faq":
        ...
        # Specific action page
            ...
            result["welcome_message"] = f"می‌بینم که در حال دیدن «{action_label}» هستی 🌟\n\nمی‌خوای درباره‌ش بیشتر بدونی یا محتوا براش تولید کنم؟"
            result["conversation_starters"] = [
    ...
    # ========================================================================
        ...
        # Report form
            ...
            result["welcome_message"] = "می‌بینم که می‌خوای گزارش کنش ثبت کنی 📝\n\nمی‌تونم کمکت کنم گزارش رو بنویسی یا اگر سوالی داری جواب بدم."
            result["conversation_starters"] = [
    ...
    # ========================================================================
        ...
        if entry_path and "/my-profile" in entry_path:
            if entry_path == "/my-profile/info":
                result["welcome_message"] = "می‌بینم که می‌خوای اطلاعات پروفایلت رو تکمیل کنی 📋\n\nبیا با هم اطلاعاتت رو کامل کنیم تا بتونی بهتر از پلتفرم استفاده کنی."
                result["conversation_starters"] = [
                ...
                result["welcome_message"] = "می‌بینم که می‌خوای کنش‌هایت رو ببینی 📋\n\nمی‌تونم کمکت کنم کنش ثبت کنی یا گزارش بدهی."
                result["conversation_starters"] = [
    ...
    # ========================================================================
        ...
        if entry_path == "/my-profile/invite-friends":
            result["welcome_message"] = "می‌بینم که می‌خوای دوستات رو دعوت کنی 🎁\n\nمی‌تونم درباره سیستم امتیازات، جوایز و کد معرف بهت توضیح بدم."
            result["conversation_starters"] = [
            ...
            result["welcome_message"] = "می‌بینم که می‌خوای دستاوردهات رو ببینی 🏆\n\nمی‌تونم درباره امتیازات، سطوح و جوایز بهت توضیح بدم."
            result["conversation_starters"] = [
                "چطور امتیاز بگیرم؟",
                "چه سطوحی وجود داره؟",
                "چه جوایزی می‌تونم بگیرم؟",
            ...
            result["welcome_message"] = "برای اطلاعات امتیازات و دعوت‌ها اینجام 🎁\n\nچه چیزی می‌خوای بدونی؟"
            result["conversation_starters"] = [
                "چطور امتیاز بگیرم؟",
                "کد معرف من چیه؟",
                "چه جوایزی می‌تونم بگیرم؟",
    ...
    # ========================================================================
        ...
        result["welcome_message"] = "چطور می‌تونم کمکت کنم؟"
        result["conversation_starters"] = [
            "چطور می‌تونم شروع کنم؟",
            "سفیران آیه‌ها چیه؟",
